...
if (!defined('EMP_LOGIN_AUTOMATIC')) {
    ...
    $db->Execute ("REPLACE INTO " . TABLE_CONFIGURATION_LANGUAGE . "
                (configuration_title, configuration_key, configuration_description, configuration_language_id) 
                VALUES ('Login als Kunde: Automatisches Login?', 'EMP_LOGIN_AUTOMATIC', 'Soll bei einem Click auf den Button &quot;Login als Kunde&quot; das Login in den Kundenaccount automatisch ohne weitere Bestätigung erfolgen?<br/>Dadurch wird die Loginseite übersprungen.',	43)");
}
